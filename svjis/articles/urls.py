...
urlpatterns = [
    ...
    path(
        'faults_fault_reopen_ticket/<int:pk>/',
        views_faults.faults_fault_reopen_ticket_view,
        name='faults_fault_reopen_ticket',
    ),
    ...
    path('project_tag_create/', views_projects.project_tag_create_view, name='project_tag_create'),
    path(
    ...
    path(
        ...
        views.get_article_cover_image,
        name="get_article_cover_image",
    ),
